...
const AuthenticationForm = () => {
  ...
  const IconInput = ({ icon: Icon, ...props }: IconInputProps) => (
    <div className="relative">
      ...
      <Input
        className="pl-10 border-neutral-light focus:border-primary-base"
        {...props}
      />
    </div>
  );
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-lg">
      ...
      <Card className="border border-neutral-lighter shadow-lg overflow-hidden flex flex-col">
            ...
            <div className="space-y-4">
              ...
              <Tabs defaultValue="password" className="w-full">
                ...
                <TabsContent value="password" className="space-y-4">
                  ...
                  <Button
                    className="w-full bg-primary-base hover:bg-primary-dark text-white"
                    size="lg"
                  >
                    Sign In
                  </Button>
                ...
                <TabsContent value="passwordless" className="space-y-2">
                  <div className="text-center">
                    <Badge
                      variant="outline"
                      className="bg-primary-lightest text-primary-dark mb-2"
                    >
                  ...
                  <div className="space-y-4">
                    ...
                    <Button
                      className="w-full mt-2 bg-primary-base hover:bg-primary-dark text-white"
                      size="lg"
                    >
                      Send Login Link
