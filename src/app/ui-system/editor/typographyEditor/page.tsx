...
} from "@/app/ui-system/components/typography/types";
import { loadTypographyTokens } from "@/app/ui-system/components/typography/utils";

const TypographyEditor = () => {
  const [allTypographyTokens, setAllTypographyTokens] = useState<
    TypographyToken[]
  >([]);
    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        localStorage.setItem(
          "typography-editor-tokens",
          JSON.stringify(allTypographyTokens)
        );
      } else {
    ...
    <div className="container mx-auto py-8">
      <div className="mb-8">
        ...
        <p className="body-lg text-foreground-weak">
          Edit your design system&apos;s typography tokens and see how they
          affect text elements
        </p>
      </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <TypographyCategoryEditor
                    ...
                    onChange={(tokens) =>
                      handleTokensChange("fontFamily", tokens)
                    }
                  />
                  <TypographyCategoryEditor
                    category="fontSize"
                    ...
                    onChange={(tokens) =>
                      handleTokensChange("fontSize", tokens)
                    }
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <TypographyCategoryEditor
                    ...
                    onChange={(tokens) =>
                      handleTokensChange("fontWeight", tokens)
                    }
                  />
                  <TypographyCategoryEditor
                    category="lineHeight"
                    ...
                    onChange={(tokens) =>
                      handleTokensChange("lineHeight", tokens)
                    }
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <TypographyCategoryEditor
                    ...
                    onChange={(tokens) =>
                      handleTokensChange("letterSpacing", tokens)
                    }
                  />
                  <TypographyCategoryEditor
                    category="maxWidth"
                    ...
                    onChange={(tokens) =>
                      handleTokensChange("maxWidth", tokens)
                    }
                  />
                </div>
              </div>
