      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent className="space-y-1">
            <div className="flex flex-wrap gap-1">
              <Badge variant="neutral">Strong</Badge>
            ...
            <div className="flex flex-wrap gap-1">
              ...
              <Badge variant="tertiary-light">Tertiary light</Badge>
            ...
            <div className="pt-6 space-y-4">
              <div className="heading-4">HeroBadge</div>
              <div className="flex flex-wrap gap-1">
                <HeroBadge icon={Users} size="sm" />
                <HeroBadge icon={Users} size="base" />
                <HeroBadge icon={Star} size="lg" />
              </div>
              <div className="flex flex-wrap gap-1">
                <HeroBadge icon={Users} size="sm" variant="neutral" />
                <HeroBadge icon={Users} size="base" variant="neutral" />
                <HeroBadge icon={Star} size="lg" variant="neutral" />
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Containers for related UI content.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              UI placeholder for loading content.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Displays short, non-disruptive notifications to users.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
