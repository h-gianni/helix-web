  ...
  render: () => (
    <div className="space-y-base">
      <div className="grid grid-cols-[auto_1fr] gap-8 items-start">
        <div className="ui-text-body-small">Default</div>
        ...
        <div className="ui-text-body-small">Primary</div>
        <div className="flex flex-wrap gap-sm">
        ...
        <div className="ui-text-body-small">Accent</div>
        <div className="flex flex-wrap gap-sm">
        ...
        <div className="ui-text-body-small">Danger</div>
        <div className="flex flex-wrap gap-sm">
        ...
        <div className="ui-text-body-small">Success</div>
        <div className="flex flex-wrap gap-sm">
        ...
        <div className="ui-text-body-small">Warning</div>
        <div className="flex flex-wrap gap-sm">
        ...
        <div className="ui-text-body-small">Info</div>
        <div className="flex flex-wrap gap-sm">
