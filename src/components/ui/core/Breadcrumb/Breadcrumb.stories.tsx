...
export const CustomStyled: Story = {
  render: () => (
    <Breadcrumb className="bg-[var(--color-surface)] p-2 rounded-md">
      <BreadcrumbList>
        <BreadcrumbItem>
          <BreadcrumbLink href="/" className="text-[var(--color-primary)]">
            <Home className="h-4 w-4" />
          </BreadcrumbLink>
        </BreadcrumbItem>
        <BreadcrumbSeparator>
        ...
        <BreadcrumbItem>
          <BreadcrumbLink href="/products" className="font-semibold">
            Products
          </BreadcrumbLink>
        </BreadcrumbItem>
        <BreadcrumbSeparator>
