...
export function BaseAreaChart({
  ...
  const { getColorPalette, chartDefaults, getLegendEffectOpacity } = useChartStyles({
    variant,
      ...
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={margin}>
          ...
          <XAxis 
            ...
            tick={{ fontSize: chartDefaults.labelFontSize, fill: chartDefaults.labelColor }}
          />
          ...
          <YAxis 
            ...
            axisLine={{ stroke: chartDefaults.axisColor }}
            tickLine={{ stroke: chartDefaults.axisColor }}
            tick={{ fontSize: chartDefaults.labelFontSize, fill: chartDefaults.tickColor }}
          />
