  ...
  render: () => (
    <Tooltip>
      <TooltipTrigger asChild>
        <Button appearance="icon-only" leadingIcon={<Info />} aria-label="Info" />
      </TooltipTrigger>
      <TooltipContent>
        Helpful information
      </TooltipContent>
    ...
    <div className="flex gap-4 items-center justify-center">
      {(['top', 'right', 'bottom', 'left'] as const).map((position) => (
        <Tooltip key={position}>
          <TooltipTrigger asChild>
            <Button appearance="icon-only" leadingIcon={<HelpCircle />} aria-label={`Help ${position}`} />
          </TooltipTrigger>
...
export const ContentStyles: Story = {
  render: () => (
    <div className="flex gap-4">
      <Tooltip>
        <TooltipTrigger asChild>
          <Button appearance="icon-only" leadingIcon={<Settings />} aria-label="Settings" />
        </TooltipTrigger>
        <TooltipContent>
          Basic tooltip
        </TooltipContent>
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button appearance="icon-only" leadingIcon={<Plus />} aria-label="Add" />
        </TooltipTrigger>
