        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ? "group-data-[collapsible=icon]:w-sidebar-icon-with-spacing"
              : "group-data-[collapsible=icon]:w-sidebar-icon"
          )}
        />
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-svh w-sidebar transition-[left,right,width] duration-200 ease-linear lg:flex",
            side === "left"
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-2xs font-normal text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
